<template>
  ...
  >
    ...
    <header class="specialist-handoff-card__header">
      ...
      <div class="specialist-handoff-card__head-meta">
        ...
        <div class="specialist-handoff-card__chips">
          ...
          <span class="specialist-handoff-card__badge">
            {{ t('personas.handoff.badge') }}
          </span>
        </div>
      </div>
      <span
    ...
    <div class="specialist-handoff-card__body">
      ...
      <template v-else-if="card.status === 'done'">
        <MessageTextPart
          v-if="card.content"
...
import type { SpecialistHandoffCard } from '#types';
...
const liveStatusMessage = computed(() => {
  ...
  if (props.card.status === 'error') {
    return t('personas.handoff.error');
  }
