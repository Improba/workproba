<!--
  Composant MBtnDropdown - Bouton dropdown Mastok avec intégration Anubis
  
  Ce composant est un wrapper autour de q-btn-dropdown de Quasar qui applique le style Mastok
  et intègre le système de couleurs Anubis. Il permet d'afficher un menu déroulant au clic.
  ...
  - lucideIcon : Nom de l'icône Lucide à afficher (ex: "menu", "more-vertical")
  ...
  Le composant supporte tous les slots et événements de q-btn-dropdown.
-->
<template>
  <q-btn-dropdown
